...
you would look at raising the number of workers by increasing :confval:`rgw_lc_max_worker`
from the default value of 3. Whereas for a workload with a higher number of objects per bucket
(hundreds of thousands) you would consider raising the number of parallel threads
